...
public record struct Color(byte R, byte G, byte B, byte A = 255) {
    ...
    /// <remarks><b>Deliberately callerless.</b> A convenience constructor; the Unity converters build their own Color32 values.</remarks>
    ...
    /// <remarks><b>Deliberately callerless.</b> A convenience accessor; nothing in the port needs a packed ARGB int.</remarks>
    public int ToArgb() {
