...
public static class GameClock {
    ...
    /// <summary>Two-second units in one day (<c>0xa8c0</c>).</summary>
    ...
    public static int HourOfDay(int gameTimeIn2Seconds) =>
        (Math.Max(0, gameTimeIn2Seconds) % UnitsPerDay) / UnitsPerHour;
}
