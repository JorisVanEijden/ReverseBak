...
public static string ToJson(this SaveGame resource) {
    ...
    public static string ToCsv(this List<ObjectInfo> resource) {
        const string objectInfoFlags =
            $"{nameof(ObjectFlags.CannotBeDiscarded)},{nameof(ObjectFlags.NotEquipable)},{nameof(ObjectFlags.B0004)},{nameof(ObjectFlags.B0008)},{nameof(ObjectFlags.DiscardWhenEmpty)},{nameof(ObjectFlags.ConsumedOnUse)},{nameof(ObjectFlags.OnlyUsableInCombat)},{nameof(ObjectFlags.SpellcastersOnly)},{nameof(ObjectFlags.NotUsableInCombat)},{nameof(ObjectFlags.NonSpellcastersOnly)},{nameof(ObjectFlags.B0400)},{nameof(ObjectFlags.Stackable)},{nameof(ObjectFlags.B1000)},{nameof(ObjectFlags.LimitedUses)},{nameof(ObjectFlags.B4000)},{nameof(ObjectFlags.B8000)}";
