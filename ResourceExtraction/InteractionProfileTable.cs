...
public static class InteractionProfileTable {
    private static readonly Dictionary<byte, (string Behavior, InteractionProfile Profile)> Map = new() {
        // byte 16 = corpse (handle_Corpse @0x76a0a).
        [16] = ("container", new InteractionProfile {
    ...
    public static bool TryGet(byte entityType, out string behavior, out InteractionProfile profile) {
