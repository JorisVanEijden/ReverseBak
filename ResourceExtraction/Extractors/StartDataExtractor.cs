...
///
/// <para>Signed, not unsigned: two of the ten are negative (the camera pitches), and reading them
/// as u16 turns -2112 into 63424 — a value that would look like a plausible angle and tilt the
/// camera the wrong way.</para>
/// </summary>
public class StartDataExtractor : ExtractorBase<StartData> {
    public override StartData Extract(string id, Stream resourceStream) {
        ...
        return new StartData(id) {
            CameraHeightAboveGround = reader.ReadInt16(),
            CameraHeightUnderground = reader.ReadInt16(),
            CameraPitchAboveGround = reader.ReadInt16(),
            CameraPitchUnderground = reader.ReadInt16(),
