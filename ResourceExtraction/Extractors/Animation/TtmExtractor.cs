...
public class TtmExtractor : ExtractorBase<AnimatorScript> {
    public override AnimatorScript Extract(string id, Stream resourceStream) {
        using var resourceReader = new BinaryReader(resourceStream, Encoding.GetEncoding(DosCodePage));

        var animator = new AnimatorScript(id);
        ...
        Stream scriptStream = compression.Decompress(resourceReader.BaseStream, tt3Size - 5);
        ...
        animator.Tags = ReadTags(resourceReader);
        ...
        while (scriptStream.Position < scriptStream.Length) {
            ...
            switch (type) {
                ...
                case 0x0510:
                    ...
                    break;
                case 0x0FF0:
                    resultScript.Frames.Add(pageCommands);
