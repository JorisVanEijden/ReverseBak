namespace BetrayalAtKrondor.Overrides.Libraries.Structures;
...
/// </summary>
public class Ffblk : MemoryBasedDataStructure {
    ...
    public Ffblk(IByteReaderWriter byteReaderWriter, uint baseAddress) : base(byteReaderWriter, baseAddress) {
    }
